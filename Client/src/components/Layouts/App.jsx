...
const App = (props) => {
  ...
  const handleLogout = () => {
    // Hapus token dari local storage atau cookie
    localStorage.removeItem('token'); // atau sesuaikan dengan metode penyimpanan Anda
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <Dropdown.Item onClick={handleLogout}>
                <a className="block w-full">Sign out</a>
              </Dropdown.Item>
            </Dropdown>
          </div>
        </div>
